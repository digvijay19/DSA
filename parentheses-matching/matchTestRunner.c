...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_odd_number_of_braces_returns_false");
	setup();
		test_odd_number_of_braces_returns_false();
	tearDown();
	testEnded();
	testStarted("test_incorrect_order_returns_false");
	setup();
		test_incorrect_order_returns_false();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_incorrect_oreder_starting_with_closing_paranthesis");
	setup();
		test_incorrect_oreder_starting_with_closing_paranthesis();
	tearDown();
	testEnded();
